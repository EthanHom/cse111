...
CREATE TABLE nation (  n_nationkey decimal(3,0) not null,
    n_name char(25) not null,
    n_regionkey decimal(2,0) not null,
    n_comment varchar(152)
);

CREATE TABLE part (  p_partkey decimal(10,0) not null,
...
CREATE TABLE supplier (  s_suppkey decimal(8,0) not null,
...
CREATE TABLE partsupp (  ps_partkey decimal(10,0) not null,
...
CREATE TABLE customer (  c_custkey decimal(9,0) not null,
...
CREATE TABLE orders (  o_orderkey decimal(12,0) not null,
...
CREATE TABLE lineitem (  l_orderkey decimal(12,0) not null,
