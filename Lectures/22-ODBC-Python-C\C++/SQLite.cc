...
protected:
    ...
    void populateTable_PC() {
        ...
        int m = 1001, r = 1024, h = 250, p = 2114; double s = 2.66;
        insert_PC(m, s, r, h, p);
    ...
    void insert_PC(int& _model, double& _speed, int& _ram, int& _hd, int& _price) {
        cout << "++++++++++++++++++++++++++++++++++\n";
        cout << "Insert PC\n";
    ...
    void populateTable_Laptop() {
        ...
        int m = 2001, r = 2048, h = 240, p = 3673; double s = 2.00, sc = 20.1;
    ...
    void insert_Laptop(int& _model, double& _speed, int& _ram,
    ...
    void populateTable_Printer() {
        ...
        int m = 3001, c = 1, p = 99; string t = string("ink-jet");
    ...
    void insert_Printer(int& _model, int& _color, string& _type, int& _price) {
        cout << "++++++++++++++++++++++++++++++++++\n";
        cout << "Insert Printer\n";
...
public:
    ...
    SQLiteODBC(string& _dbFile) : dbName(_dbFile), isConnected(false) {}
    ...
    void ProductByMaker(string& _pType, string& _maker) {
        cout << "++++++++++++++++++++++++++++++++++\n";
    ...
    void AllProductsByMaker(string& _maker) {
        cout << "++++++++++++++++++++++++++++++++++\n";
...
/*
    Compile with: g++ -g -O0 -Wno-deprecated -o SQLite.exe SQLite.cc -lsqlite3
