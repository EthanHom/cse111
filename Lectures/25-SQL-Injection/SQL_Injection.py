...
def printerByType_script_insecure(_conn, _type):
    print("++++++++++++++++++++++++++++++++++")
    print("Printer by type: ", _type)
...
def main():
    ...
    with conn:
        ...
        #printerByType_secure(conn, "laser' OR '1'='1")

        # EXTRACT ATTRIBUTE VALUES
        #printerByType_insecure(conn, "laser")
        #printerByType_insecure(conn, "laser' OR type LIKE \'%ink%")
        #printerByType_secure(conn, "laser' OR type LIKE \'%ink%")

        #printerByType_insecure(conn,
        #    """laser' UNION
        #    select model, price from PC --""")
        #printerByType_secure(conn,
        #    """laser' UNION
        #    select model, price from PC --""")
        ...
        #printerByType_insecure(conn, "laser")
        #printerByType_insecure(conn, "laser' AND colors = true --")
        #printerByType_insecure(conn, "laser' AND color = true --")
        #printerByType_secure(conn, "laser' AND color = true --")
        ...
        # EXTRACT TABLE NAMES
        #printerByType_insecure(conn,
        #    """laser' AND 1 = (select count(*) from PCs) --""")
        #printerByType_insecure(conn,
        #    """laser' AND 1 = (select count(*) from PC) --""")
        #printerByType_insecure(conn,
